angular.module('MetronicApp').controller('AdjusterPropertyClaimController', function ($uibModal, $state,
    ...
    function GetVendorAssignmnetItemList(item) {
        ...
        getItemList.then(function (success) {
            ...
            angular.forEach($scope.AssignmentItemList,function(item1){
                if(item1.comparableItems != null){
                 console.log("item1",item1);
                    angular.forEach(item1.comparableItems,function(item2){
                        if(item2.isReplacementItem){
                            item1.MERflag=true;
                        }
                        console.log("item2",item2);
                        console.log("flag1",$scope.MERflag)
                    })
                }
            })
console.log("assigmentList", $scope.AssignmntItemList);
            // Tax calculations
  ...
  function GetInsuranceCompanyDetails() {
      ...
      var getCompanyDetails = AdjusterPropertyClaimDetailsService.GetInsuranceCompanyDetails(param);
  ...
  function downloadPDF(item) {
      ...
      var getMERReport = AdjusterPropertyClaimDetailsService.getMERReport(param);
