angular.module('MetronicApp').controller('SupervisorClaimDetailsController', function ($rootScope, $filter, $uibModal, $window, $scope, $state, $stateParams, settings, $http, $timeout, $location, $translate,
    $translatePartialLoader, AuthHeaderService, SupervisorClaimDetailsService,
...
var underReviewItems;
    ...
    function GetInsuranceCompanyDetails() {
        ...
        var getCompanyDetails = SupervisorClaimDetailsService.GetInsuranceCompanyDetails(param);
    ...
    function downloadPDF(item){
        ...
        var getMERReport = SupervisorClaimDetailsService.getMERReport(param);
